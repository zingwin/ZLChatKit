...
@implementation ZLInputToolView
...
- (void)setupSubviews
{
    ...
    // 初始化输入框
    self.inputTextView = [[ZLInputMessageTextView  alloc] initWithFrame:CGRectMake(textViewLeftMargin, kVerticalPadding, width, kInputTextViewMinHeight)];
    ...
    if (!self.faceView) {
        self.faceView = [[ZLFaceView alloc] initWithFrame:CGRectMake(0, (kVerticalPadding * 2 + kInputTextViewMinHeight), self.frame.size.width, kBottomContainViewHeight)];
        [(ZLFaceView *)self.faceView setDelegate:self];
        [(ZLFaceView *)self.faceView setInputTextView:self.inputTextView];
        self.faceView.backgroundColor = [UIColor lightGrayColor];
        self.faceView.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
    }
    
    if (!self.recordView) {
        self.recordView = [[ZLRecordAnimationView alloc] initWithFrame:CGRectMake(90, 130, 140, 140)];
    }
...
{
    if ([self.recordView isKindOfClass:[ZLRecordAnimationView class]]) {
        [(ZLRecordAnimationView *)self.recordView recordButtonTouchDown];
    }
...
- (void)recordButtonTouchUpOutside
{
    ...
    if ([self.recordView isKindOfClass:[ZLRecordAnimationView class]]) {
        [(ZLRecordAnimationView *)self.recordView recordButtonTouchUpOutside];
    }
...
{
    if ([self.recordView isKindOfClass:[ZLRecordAnimationView class]]) {
        [(ZLRecordAnimationView *)self.recordView recordButtonTouchUpInside];
    }
...
{
    if ([self.recordView isKindOfClass:[ZLRecordAnimationView class]]) {
        [(ZLRecordAnimationView *)self.recordView recordButtonDragOutside];
    }
...
{
    if ([self.recordView isKindOfClass:[ZLRecordAnimationView class]]) {
        [(ZLRecordAnimationView *)self.recordView recordButtonDragInside];
    }
...
- (void)cancelTouchRecord
{
    ...
    if ([_recordView isKindOfClass:[ZLRecordAnimationView class]]) {
        [(ZLRecordAnimationView *)_recordView recordButtonTouchUpInside];
