...
@implementation ZLInputMessageTextView
...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [[self class] maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
    return [[self class] numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [[self class] maxCharactersPerLine]) + 1;
}
